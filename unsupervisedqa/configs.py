...
## Spacy Configs:
SPACY_MODEL = 'en_core_web_sm' # Newer v3 SpaCy requires the full name
...
# CONSTITUENCY_MODEL = "models/elmo-constituency-parser-2018.03.14.tar.gz"

CONSTITUENCY_BATCH_SIZE = 32
CONSTITUENCY_CUDA = -1#0
